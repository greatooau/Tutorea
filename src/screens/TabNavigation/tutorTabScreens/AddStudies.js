    ...
    const onSubmitHandler = async () => {
        if (
            ...
            const body = {
                study,
                school,
                img:'https://d7rh5s3nxmpy4.cloudfront.net/CMP1431/1/LHIL153BI25431_USA_000041_Roosevelt_High_School_IMD.JPG'
            };
            ...
            if (response.status === 200) {
                ...
                Alert.alert("Error", "El estudio no pudo ser agregado con éxito");
            }
        }
    };
        ...
        <View style={styles.rectangle}>
            ...
            <View style={styles.profile}>
                ...
                <View style={{ paddingTop: 20 }}>
                    ...
                    <Text style={styles.profileText}>Agregar Estudios</Text>
                </View>
            </View>
